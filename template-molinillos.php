<?php
/*
	Template Name: Listar Molinillos
		...
		<div id="primary" class="primary without-sidebar">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<div class="entry-header">
					<h1><?php _e('Todos los Molinillos de Café');?></h1>
				</div>
			...
			<div class="clear"></div>
			<input type="hidden" id="cmcPostType" value="related_product_1">
