...
function cmc_scripts_header() {
		...
		// wp_enqueue_style('nhf-style', get_template_directory_uri().'/assets/css/_style.min.css');
		// wp_enqueue_style('nhf-override', get_template_directory_uri().'/assets/css/override.min.css');
...
*/
		...
		wp_enqueue_script('cmc-global-js', get_template_directory_uri().'/assets/js/global.min.js', array('jquery'), '1.0', false);
		...
		if(is_tax('product-category') || is_page_template('template-cafeteras.php') || is_page_template('template-molinillos.php') || is_page_template('template-espumadores-de-leche.php')) {
			wp_enqueue_script('cmc-taxonomy-js', get_template_directory_uri().'/assets/js/taxonomy.min.js', array('jquery'), '1.0', false);
		...
		// wp_enqueue_script('nhf-bootstrap', get_template_directory_uri().'/assets/bootstrap/bootstrap.bundle.min.js');
