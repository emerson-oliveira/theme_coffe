...
?>
    ...
    <div id="upload_brand_preview">
        ...
        <?php /* ENABLED */ ?>
        <?php /*
        <?php if ( $image_url_string == '/wp-content/themes/ultimateazon/images/no-product-image.jpg') {$hideshow='style="display: inline-block"';} else {$hideshow='style="display: none"';} ?>
