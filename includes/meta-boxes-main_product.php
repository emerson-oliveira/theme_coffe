...
function uat_main_product_image_function($post) { 
    ...
    <div id="upload_mainproduct_preview">
        ...
        <?php /* ENABLED */ ?>
        <?php /*
        <?php if ( $image_url_string == '/wp-content/themes/comprarmicafetera/img/no-product-image.jpg') {$hideshow='style="display: inline-block"';} else {$hideshow='style="display: none"';} ?>
