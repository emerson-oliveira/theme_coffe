			...
			<div class="group-product-grid">
				<div class="product-grid-1">
					<div class="product-menu">
						...
						<div class="product-menu-menu">
							<div><span class="number">1</span> <button href="Características" rel="nofollow">Características</button></div>
							<div><span class="number">2</span> <button href="Ventajas" rel="nofollow">Ventajas</button></div>
							<div><span class="number">3</span> <button href="Desventajas" rel="nofollow">Desventajas</button></div>
							<div><span class="number">4</span> <button href="Conclusiones" rel="nofollow">Conclusiones</button></div>
						</div>
				...
				<div class="product-grid-2">
					<div class="product-header">
						...
						<div class="product-img mobile"><img src="<?php echo $data['image']; ?>"></div>
					...
					<?php if(get_post_type() == 'main_product') : ?>
						<div class="related-products"><h3><?php _e('Productos Relacionados'); ?></h3><?php
				...
				<div class="product-grid-3">
					<?php /*<div class="product-img"><img src="<?php echo $data['image']; ?>"></div> */ ?>
					<?php get_sidebar(); ?>
				</div>
